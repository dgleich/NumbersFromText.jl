...
struct NewlineOnly <: DelimiterCodes end
@inline match(::Type{NewlineOnly}, c::UInt8) = c == UInt8('\n')
...
export Spaces, NewlineOnly, Newlines, SpacesTabs, SpacesTabsNewlines, CommasSpacesTabs,
